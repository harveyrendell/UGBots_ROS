...
echo \<node pkg=\"ugbots_ros\" name=\"visitornode\" type=\"VISITOR\" output=\"screen\"\/\> >> ugbots_ros/launch/world.launch 
echo \<\/group\> >> ugbots_ros/launch/world.launch
...
echo \<group ns=\"robot_$i\"\> >> ugbots_ros/launch/world.launch
echo \<node pkg=\"ugbots_ros\" name=\"dognode\" type=\"DOG\" output=\"screen\"\/\> >> ugbots_ros/launch/world.launch 
echo \<\/group\> >> ugbots_ros/launch/world.launch
